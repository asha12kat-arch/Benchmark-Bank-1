            ...
            {TRANSACTIONS.map((t, i) => (
              <div key={t.id}>
                <div className="content-stretch flex items-center gap-[12px] p-[14px] relative shrink-0 w-full min-w-0">
                  ...
                  <p className={`font-['Geist:SemiBold',sans-serif] font-semibold relative shrink-0 w-[100px] min-w-0 text-right overflow-hidden text-[14px] ${t.amount > 0 ? "text-[#15803d]" : "text-[#f87171]"}`}>
